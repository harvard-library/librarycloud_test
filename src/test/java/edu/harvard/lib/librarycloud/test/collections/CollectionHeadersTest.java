...
public class CollectionHeadersTest extends CollectionTestBase {
    ...
    public void collectionsTestAccessControlHeaders() throws Exception {
        get("/collections").then().assertThat().headers("Access-Control-Allow-Origin","*",
                                                        "Access-Control-Allow-Methods", "GET,POST,DELETE,PUT",
                                                        "Access-Control-Allow-Headers", "Access-Control-Allow-Headers,Content-Type,Accept,X-Requested-With,X-LibraryCloud-API-Key",
